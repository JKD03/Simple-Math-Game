...
class Game_activity2 : AppCompatActivity() {
            ...
            if(check==0)
            {
                ...
                if(userlife==0)
                {
                    Toast.makeText(applicationContext,"Game Over",
                        Toast.LENGTH_LONG).show()
                    val intent = Intent(this@Game_activity2,ResultActivity::class.java)
    ...
    fun gamecontinue()
    {
        ...
        do {
            ...
            num1 = Random.nextInt(num01,1000)
            num2 = Random.nextInt(num02,1000)
        }while(num1>num2)
