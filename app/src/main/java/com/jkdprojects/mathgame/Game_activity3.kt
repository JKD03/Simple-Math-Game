...
class Game_activity3 : AppCompatActivity() {
            ...
            if(check==0)
            {
                ...
                if(userlife==0)
                {
                    Toast.makeText(applicationContext,"Game Over",
                        Toast.LENGTH_LONG).show()
                    val intent = Intent(this@Game_activity3,ResultActivity::class.java)
    ...
    fun gamecontinue()
    {
        val num01 = Random.nextInt(2,20)
        val num02 = Random.nextInt(25,50)
        val num1 = Random.nextInt(num01,100)
        val num2 = Random.nextInt(num02,100)
        sum=num1*num2
